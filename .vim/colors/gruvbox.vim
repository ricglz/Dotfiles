...
" Plugin specific -------------------------------------------------------------
" BufTabLine: {{{
call s:HL('BufTabLineCurrent', s:fg4, s:bg0)
call s:HL('BufTabLineActive', s:bg0, s:fg4)
call s:HL('BufTabLineHidden', s:bg4, s:bg1)
call s:HL('BufTabLineFill', s:bg0, s:bg0)
" }}}
" StatusLine: {{{
call s:HL('stlDirInfo', s:fg3, s:bg1)
call s:HL('stlErrorInfo', s:gb.bright_red, s:bg1)
call s:HL('stlInsertMode', s:gb.bright_green, s:bg0)
call s:HL('stlModified', s:gb.bright_red, s:bg2)
call s:HL('stlNormalMode', s:gb.bright_purple, s:bg0)
call s:HL('stlReplaceMode', s:gb.bright_aqua, s:bg0)
call s:HL('stlSelectMode', s:gb.bright_aqua, s:bg0)
call s:HL('stlTerminalMode', s:gb.purple, s:bg0)
call s:HL('stlTypeInfo', s:gb.bright_aqua, s:bg1)
call s:HL('stlVisualMode', s:gb.bright_orange, s:bg0)
" }}}
" coc.nvim: {{{
